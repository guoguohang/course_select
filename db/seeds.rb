...
class StudentGenerator
  ...
  DEPARTMENT= %w(计算机科学与技术学院 软件研究所 计算机技术研究所 自动化研究所 信息工程研究所)
...
teacher_map={
    ...
    2 => {name: "谢高岗", department: "计算机科学与技术学院"},
    3 => {name: "魏峻", department: "软件研究所"},
    4 => {name: "罗铁坚", department: "计算机科学与技术学院"},
    5 => {name: "眭跃飞", department: "软件研究所"},
    6 => {name: "卜东波", department: "计算技术研究所"},
    7 => {name: "黄庆明", department: "计算机科学与技术学院"},
    8 => {name: "程学旗", department: "计算技术研究所"},
    9 => {name: "李晓维", department: "计算技术研究所"},
    10 => {name: "齐洪钢", department: "计算机科学与技术学院"},
    11 => {name: "刘莹", department: "计算机科学与技术学院"},
    12 => {name: "冯晓兵", department: "计算技术研究所"},
    13 => {name: "杨力祥", department: "计算机科学与技术学院"},
    ...
    25 => {name: "李保滨", department: "计算机科学与技术学院"},
    26 => {name: "何苯", department: "计算机科学与技术学院"},
    27 => {name: "张颢", department: "计算机科学与技术学院"},
    28 => {name: "刘智勇", department: "自动化研究所"},
    29 => {name: "赵军锁", department: "软件研究所"},
    30 => {name: "陈玉福", department: "软件研究所"},
    31 => {name: "刘玉贵", department: "计算机科学与技术学院"},
    32 => {name: "王文杰", department: "计算机科学与技术学院"},
    33 => {name: "苏桂平", department: "计算机科学与技术学院"},
    34 => {name: "张晋连", department: "计算机科学与技术学院"}
}
...
(1..200).each do |index|
  student=User.create!(
      ...
      num: "2020#{Faker::Number.number(11)}",
...
course_info_map.keys.each do |index|
  CourseInfo.create!(
      course_id: course_info_map[index][:course_code],
